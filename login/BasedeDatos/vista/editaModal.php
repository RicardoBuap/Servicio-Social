    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editaModalLabel">Modificar registro</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" autocomplete="off" action="../controlador/actualiza.php" id="formRegistro">
                    <div class="row mb-2">
                        <div class="col-5">
                    ...
                    <div class="row mb-2">
                        <div class="col-11">
                            ...
                            <textarea class="form-control limpiar" id="descripcion" rows="7" name="descripcion" required></textarea>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-5">
                            <label class="form-label">Rango</label>
                            <input type="number" id="rango" class="form-control limpiar" min="0" name="rango" placeholder="Ingrese el rango" required>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row mb-2">
                        <div class="col-11">
                            ...
                            <input type="text" id="etiquetaY" class="form-control limpiar" name="etiquetaY" required placeholder="Ingrese el eje Y">
                        </div>
                        <div class="col-11">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <button type="button" onclick="registrarGrafica()" class="btn btn-outline-success">Registrar</button>
                    </div>
                </div>
                </form>
            </div>
...
<script>
    //Verificación columnas vacías
    let editaModalEventos = document.getElementById("editaModal");

    function manejarInputColumna(idColumna, claseInputsPeriodicos) {
        editaModalEventos.querySelector('.modal-body #' + idColumna).addEventListener("input", function() {
            let valorColumna = editaModalEventos.querySelector('.modal-body #' + idColumna).value;
            let inputsPeriodicos = editaModalEventos.querySelectorAll('.modal-body .' + claseInputsPeriodicos);
    ...
    function registrarGrafica() {
        // Cambia la acción del formulario para apuntar a registra.php
        let form = document.getElementById("formRegistro");
        form.action = '../controlador/guarda.php';
        // Envía el formulario
        form.submit();
    }
